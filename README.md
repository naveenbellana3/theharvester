...
* https://github.com/naveenbellana/theHarvester/wiki/Installation
...
Clone the repository:
   ```bash
   git clone https://github.com/naveenbellana/theHarvester
   cd theHarvester
   ```
...
* fofa: FOFA search engine (https://en.fofa.info)
...
-------------------------------
Documentation to setup API keys can be found at - https://github.com/naveenbellana/theHarvester/wiki/Installation#api-keys
...
* dnsdumpster - 50 free queries/day, $49
...
* intelx - free account is very limited. Business account $2900
...
* virustotal - 500 free lookups/day, 15.5k lookups/month. Business accounts requires a work email
...
----------------------------
* Naveen Bellana - naveenbellana04@gmail.com
* Christian Martorella @laramies (Original Author)
...
Maintainer
----------
Naveen Bellana is a Security Analyst with over 4 years of experience in cybersecurity operations, including incident response, vulnerability management, and risk assessment. With a strong background in Python and automation scripting, Naveen maintains this project to provide a reliable tool for reconnaissance and OSINT gathering. His expertise spans across cloud environments and enterprise IT, focusing on streamlining security workflows and maintaining robust organizational security postures.
